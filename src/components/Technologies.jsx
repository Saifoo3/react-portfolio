    ...
    <div className="border-b border-neutral-900 pb-24 ">
      ...
      >
        ...
        >
          ...
          <p className="mt-4 text-md text-gray-700">React</p>
        </motion.div>
        ...
        >
          ...
          <p className="mt-4 text-md text-gray-700">React Native</p>
        </motion.div>
        ...
        >
          ...
          <p className="mt-4 text-md text-gray-700">Node.js</p>
        </motion.div>
        ...
        >
          ...
          <p className="mt-4 text-md text-gray-700">Next.js</p>
        </motion.div>
        ...
        >
          ...
          <p className="mt-4 text-md text-gray-700">MongoDB</p>
        </motion.div>
        ...
        >
          ...
          <p className="mt-4 text-md text-gray-700">MySQL</p>
        </motion.div>
        ...
        >
          ...
          <p className="mt-4 text-md text-gray-700">Power BI</p>
        </motion.div>
        ...
        >
          ...
          <p className="mt-4 text-md text-gray-700">Git</p>
        </motion.div>
        ...
        >
          ...
          <p className="mt-4 text-md text-gray-700">Linux</p>
        </motion.div>
      </motion.div>
    </div>
  );
